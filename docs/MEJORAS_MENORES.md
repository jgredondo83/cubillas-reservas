...
- [ ] MEJORA — Implementar UI de edición de textos_admin en el panel admin (sección "Textos" del sidebar). Permitirá editar contacto_general, contacto_administracion y otros textos sin tocar SQL. Útil para actualizar teléfonos de vigilantes o datos de contacto sin deploy.
